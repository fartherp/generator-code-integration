 ...
 * Date: 2015/6/13
 */
public class OpServiceImplGenerator extends AbstractJavaElementGenerator<OpAttributes> {
    public OpServiceImplGenerator(TableInfoWrapper<OpAttributes> tableInfoWrapper) {
        super(tableInfoWrapper);
    }

    public void prepareElement() {
        javaTypeInfo = attributes.getServiceImpl();
        superClass = new JavaTypeInfo("jz.com.asset.service.impl.BaseServiceImpl" + attributes.getPk());
    ...
    public void dealElement(TopLevelClass topLevelClass) {
        ...
        JavaTypeInfo baseMapper = new JavaTypeInfo("jz.com.asset.dao.BaseMapper" + attributes.getPk());
